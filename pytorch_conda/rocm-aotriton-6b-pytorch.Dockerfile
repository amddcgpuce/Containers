...
#FROM rocm:6.2.0-ub22-hipmagmav280-aot6b

# README
# time podman build --no-cache --security-opt label=disable --build-arg base_rocm_docker=amddcgpuce/rocm:6.2.0-ub22-hipmagmav280-aot6b --build-arg rocm_version=6.2.0 -v $HOME:/workdir -t amddcgpuce/rocm:6.2.0-ub22-aot6b-pt241_py310_0191 -f rocm-aotrition-6b-pytorch.Dockerfile `pwd`
